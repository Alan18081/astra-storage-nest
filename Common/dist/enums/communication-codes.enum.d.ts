export declare enum CommunicationCodes {
    GET_USERS_LIST = "[UsersServiceOld] Get Users List",
    GET_USER = "[UsersServiceOld] Get User",
    GET_USER_BY_GOOGLE_ID = "[UsersServiceOld] Get User By Google Id",
    GET_USER_BY_ID = "[UsersServiceOld] Get User By ID",
    GET_USER_BY_EMAIL = "[UsersServiceOld] Get User By Email",
    CREATE_USER = "[UsersServiceOld] Create User",
    CREATE_USER_BY_GOOGLE = "[UsersServiceOld] Get User By Google",
    UPDATE_USER = "[UsersServiceOld] Update User",
    REMOVE_USER = "[UsersServiceOld] Remove User",
    RESET_USER_PASSWORD = "[UsersServiceOld] Reset User Password",
    ...
    CREATE_REFRESH_TOKEN = "[UsersServiceOld] Create Refresh Token",
    GET_REFRESH_TOKEN_BY_TOKEN = "[UsersServiceOld] Get Refresh Token By Token",
    REMOVE_REFRESH_TOKEN = "[UsersServiceOld] Remove Refresh Token",
    EXCHANGE_TOKEN = "[AuthService] Exchange Token",
    GET_USER_HASH_BY_HASH = "[UsersServiceOld] Get User Hash By Hash",
    SEND_RESET_PASSWORD_EMAIL = "[EmailsService] Send Reset Password Email",
    VERIFY_RESET_PASSWORD_HASH = "[UsersServiceOld] Verify Reset Password Hash",
    SET_NEW_PASSWORD = "[UsersServiceOld] Set New Password",
    CHANGE_USER_PASSWORD = "[UsersServiceOld] Change User Password",
