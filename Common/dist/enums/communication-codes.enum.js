...
(function (CommunicationCodes) {
    CommunicationCodes["GET_USERS_LIST"] = "[UsersServiceOld] Get Users List";
    CommunicationCodes["GET_USER"] = "[UsersServiceOld] Get User";
    CommunicationCodes["GET_USER_BY_GOOGLE_ID"] = "[UsersServiceOld] Get User By Google Id";
    CommunicationCodes["GET_USER_BY_ID"] = "[UsersServiceOld] Get User By ID";
    CommunicationCodes["GET_USER_BY_EMAIL"] = "[UsersServiceOld] Get User By Email";
    CommunicationCodes["CREATE_USER"] = "[UsersServiceOld] Create User";
    CommunicationCodes["CREATE_USER_BY_GOOGLE"] = "[UsersServiceOld] Get User By Google";
    CommunicationCodes["UPDATE_USER"] = "[UsersServiceOld] Update User";
    CommunicationCodes["REMOVE_USER"] = "[UsersServiceOld] Remove User";
    CommunicationCodes["RESET_USER_PASSWORD"] = "[UsersServiceOld] Reset User Password";
    ...
    CommunicationCodes["CREATE_REFRESH_TOKEN"] = "[UsersServiceOld] Create Refresh Token";
    CommunicationCodes["GET_REFRESH_TOKEN_BY_TOKEN"] = "[UsersServiceOld] Get Refresh Token By Token";
    CommunicationCodes["REMOVE_REFRESH_TOKEN"] = "[UsersServiceOld] Remove Refresh Token";
    CommunicationCodes["EXCHANGE_TOKEN"] = "[AuthService] Exchange Token";
    CommunicationCodes["GET_USER_HASH_BY_HASH"] = "[UsersServiceOld] Get User Hash By Hash";
    CommunicationCodes["SEND_RESET_PASSWORD_EMAIL"] = "[EmailsService] Send Reset Password Email";
    CommunicationCodes["VERIFY_RESET_PASSWORD_HASH"] = "[UsersServiceOld] Verify Reset Password Hash";
    CommunicationCodes["SET_NEW_PASSWORD"] = "[UsersServiceOld] Set New Password";
    CommunicationCodes["CHANGE_USER_PASSWORD"] = "[UsersServiceOld] Change User Password";
