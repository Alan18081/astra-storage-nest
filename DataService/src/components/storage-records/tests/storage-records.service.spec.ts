...
import {StorageRecordsService} from '../storage-records.service';
  ...
  describe('removeByStorageId', () => {
    const storageId = 15;
    it('should call storageRecordsRepository.removeByStorage', async () => {
      const spy = jest.spyOn(mockStorageRecordsRepository, 'removeByStorage').mockImplementation(async () => {});
      await storageRecordsService.removeByStorage(storageId);
